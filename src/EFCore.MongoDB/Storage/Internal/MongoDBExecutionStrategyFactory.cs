...
/// </summary>
public class MongoDBExecutionStrategyFactory : IExecutionStrategyFactory
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoDBExecutionStrategyFactory(ExecutionStrategyDependencies dependencies)
    {
        Dependencies = dependencies;

        _createExecutionStrategy = dependencies.Options.FindExtension<MongoDBOptionsExtension>()?.ExecutionStrategyFactory
    ...
    protected virtual IExecutionStrategy CreateDefaultStrategy(ExecutionStrategyDependencies dependencies)
        => new MongoDBExecutionStrategy(dependencies);
