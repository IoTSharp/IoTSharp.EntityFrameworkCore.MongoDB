...
public static class MongoDBModelBuilderExtensions
{
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return modelBuilder.CanSetAnnotation(MongoDBAnnotationNames.ContainerName, name, fromDataAnnotation);
    }
    ...
    public static bool CanSetThroughput(
        ...
        bool fromDataAnnotation = false)
    {
        var existingAnnotation = modelBuilder.Metadata.FindAnnotation(MongoDBAnnotationNames.Throughput);
