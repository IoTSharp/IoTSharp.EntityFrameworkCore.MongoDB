...
/// <summary>
///     MongoDB-specific extension methods for <see cref="EntityTypeBuilder" />.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    ///     Configures the container that the entity type maps to when targeting Azure MongoDB.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships</see>, and
    ///     <see href="https://aka.ms/efcore-docs-MongoDB">Accessing Azure MongoDB DB with EF Core</see> for more information and examples.
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(MongoDBAnnotationNames.ContainerName, name, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(MongoDBAnnotationNames.PropertyName, name, fromDataAnnotation);
    }
    ...
    public static EntityTypeBuilder<TEntity> HasPartitionKey<TEntity>(
        ...
        string? name)
        where TEntity : class
        => (EntityTypeBuilder<TEntity>)((EntityTypeBuilder)entityTypeBuilder).HasPartitionKey(name);
        ...
        where TEntity : class
    {
        ...
        return entityTypeBuilder.HasPartitionKey(propertyExpression.GetMemberAccess().GetSimpleMemberName());
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(MongoDBAnnotationNames.PartitionKeyName, name, fromDataAnnotation);
    }

    /// <summary>
    ///     Configures this entity to use MongoDBDb etag concurrency checks.
    /// </summary>
    /// <remarks>
    ///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships</see>, and
    ///     <see href="https://aka.ms/efcore-docs-MongoDB">Accessing Azure MongoDB DB with EF Core</see> for more information and examples.
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(MongoDBAnnotationNames.AnalyticalStoreTimeToLive, seconds, fromDataAnnotation);
    }
    ...
    public static bool CanSetDefaultTimeToLive(
        ...
        int? seconds,
        bool fromDataAnnotation = false)
        => entityTypeBuilder.CanSetAnnotation(MongoDBAnnotationNames.DefaultTimeToLive, seconds, fromDataAnnotation);
    ...
    public static bool CanSetThroughput(
        ...
        bool fromDataAnnotation = false)
    {
        var existingAnnotation = entityTypeBuilder.Metadata.FindAnnotation(MongoDBAnnotationNames.Throughput);
