...
/// </remarks>
public static class MongoDBPropertyBuilderExtensions
{
    /// <summary>
    ///     Configures the property name that the property is mapped to when targeting Azure MongoDB.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    /// <summary>
    ///     Configures the property name that the property is mapped to when targeting Azure MongoDB. If an empty string is
    ...
    public static bool CanSetJsonProperty(
        ...
        string? name,
        bool fromDataAnnotation = false)
        => propertyBuilder.CanSetAnnotation(MongoDBAnnotationNames.PropertyName, name, fromDataAnnotation);
