...
/// <summary>
///     MongoDB-specific extension methods for LINQ queries.
/// </summary>
/// <remarks>
...
public static class MongoDBQueryableExtensions
{
    internal static readonly MethodInfo WithPartitionKeyMethodInfo
        = typeof(MongoDBQueryableExtensions).GetTypeInfo().GetDeclaredMethod(nameof(WithPartitionKey))!;
    ...
    ///         arguments. Any parameter values you supply will automatically be converted to a MongoDB parameter.
    ///     </para>
    ///     <para>
    ///         See <see href="https://aka.ms/efcore-docs-query">Querying data with EF Core</see>, and
    ///         <see href="https://aka.ms/efcore-docs-MongoDB">Accessing Azure MongoDB DB with EF Core</see> for more information
    ///         and examples.
    ///     </para>
    /// </remarks>
        ...
        where TEntity : class
    {
        ...
        Check.DebugAssert(
            ...
            "Found FromSql on a TPT entity type, but TPT isn't supported on MongoDB");
