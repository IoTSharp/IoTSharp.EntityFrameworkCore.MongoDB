...
/// </summary>
public class MongoDBMemberTranslatorProvider : IMemberTranslatorProvider
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoDBMemberTranslatorProvider(
        ...
        IEnumerable<IMemberTranslatorPlugin> plugins)
    {
        ...
        _translators
            .AddRange(
                ...
                {
                    new MongoDBStringMemberTranslator(sqlExpressionFactory), new MongoDBDateTimeMemberTranslator(sqlExpressionFactory)
                });
    }
