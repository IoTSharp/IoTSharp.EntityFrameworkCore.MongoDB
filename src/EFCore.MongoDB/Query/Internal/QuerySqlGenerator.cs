...
public class QuerySqlGenerator : SqlExpressionVisitor
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBSqlQuery GetSqlQuery(
        ...
        IReadOnlyDictionary<string, object> parameterValues)
    {
        ...
        return new MongoDBSqlQuery(_sqlBuilder.ToString(), _sqlParameters);
    }
    ...
    protected override Expression VisitSelect(SelectExpression selectExpression)
    {
            ...
            || selectExpression.Limit != null)
        {
            ...
            else
            {
                ...
                throw new InvalidOperationException(MongoDBStrings.OffsetRequiresLimit);
            }
        }
        ...
        switch (fromSqlExpression.Arguments)
        {
            ...
            default:
                throw new ArgumentOutOfRangeException(
                    ...
                    MongoDBStrings.InvalidFromSqlArguments(
