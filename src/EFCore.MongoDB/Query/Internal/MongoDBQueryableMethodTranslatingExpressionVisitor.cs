...
/// </summary>
public class MongoDBQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    private readonly QueryCompilationContext _queryCompilationContext;
    private readonly ISqlExpressionFactory _sqlExpressionFactory;
    private readonly IMemberTranslatorProvider _memberTranslatorProvider;
    private readonly IMethodCallTranslatorProvider _methodCallTranslatorProvider;
    private readonly MongoDBSqlTranslatingExpressionVisitor _sqlTranslator;
    private readonly MongoDBProjectionBindingExpressionVisitor _projectionBindingExpressionVisitor;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoDBQueryableMethodTranslatingExpressionVisitor(
        ...
        : base(dependencies, queryCompilationContext, subquery: false)
    {
        ...
        _sqlTranslator = new MongoDBSqlTranslatingExpressionVisitor(
            queryCompilationContext,
            _sqlExpressionFactory,
            _memberTranslatorProvider,
            _methodCallTranslatorProvider);
        _projectionBindingExpressionVisitor =
            new MongoDBProjectionBindingExpressionVisitor(_queryCompilationContext.Model, _sqlTranslator);
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected MongoDBQueryableMethodTranslatingExpressionVisitor(
        MongoDBQueryableMethodTranslatingExpressionVisitor parentVisitor)
    ...
    protected override QueryableMethodTranslatingExpressionVisitor CreateSubqueryVisitor()
        => new MongoDBQueryableMethodTranslatingExpressionVisitor(this);
    ...
    protected override ShapedQueryExpression TranslateReverse(ShapedQueryExpression source)
    {
        ...
        {
            AddTranslationErrorDetails(MongoDBStrings.MissingOrderingInSelectExpression);
            return null;
        }
