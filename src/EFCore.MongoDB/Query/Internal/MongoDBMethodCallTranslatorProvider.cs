...
/// </summary>
public class MongoDBMethodCallTranslatorProvider : IMethodCallTranslatorProvider
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoDBMethodCallTranslatorProvider(
        ...
        IEnumerable<IMethodCallTranslatorPlugin> plugins)
    {
        ...
        _translators.AddRange(
            new IMethodCallTranslator[]
            {
                ...
                new MongoDBStringMethodTranslator(sqlExpressionFactory),
