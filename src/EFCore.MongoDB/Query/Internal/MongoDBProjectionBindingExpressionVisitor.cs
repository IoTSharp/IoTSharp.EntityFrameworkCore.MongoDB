...
/// </summary>
public class MongoDBProjectionBindingExpressionVisitor : ExpressionVisitor
{
    private static readonly MethodInfo GetParameterValueMethodInfo
        = typeof(MongoDBProjectionBindingExpressionVisitor)
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public MongoDBProjectionBindingExpressionVisitor(
        IModel model,
        MongoDBSqlTranslatingExpressionVisitor sqlTranslator)
    {
        _model = model;
            ...
            case IncludeExpression includeExpression:
                        ...
                        && includableNavigation.IsEmbedded()))
                {
                    throw new InvalidOperationException(
                        MongoDBStrings.NonEmbeddedIncludeNotSupported(includeExpression.Navigation));
                }
