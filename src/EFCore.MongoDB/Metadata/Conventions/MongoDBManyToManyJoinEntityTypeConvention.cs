...
/// </remarks>
public class MongoDBManyToManyJoinEntityTypeConvention :
    ManyToManyJoinEntityTypeConvention,
    IEntityTypeAnnotationChangedConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="MongoDBManyToManyJoinEntityTypeConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    public MongoDBManyToManyJoinEntityTypeConvention(ProviderConventionSetBuilderDependencies dependencies)
        : base(dependencies)
    {
    }
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        if (name == MongoDBAnnotationNames.PartitionKeyName
            || name == MongoDBAnnotationNames.ContainerName)
        {
