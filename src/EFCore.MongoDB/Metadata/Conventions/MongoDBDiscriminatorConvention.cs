...
/// </remarks>
public class MongoDBDiscriminatorConvention :
...
{
    /// <summary>
    ///     Creates a new instance of <see cref="MongoDBDiscriminatorConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    public MongoDBDiscriminatorConvention(ProviderConventionSetBuilderDependencies dependencies)
        : base(dependencies)
    {
    }
    ...
    {
        if (name != MongoDBAnnotationNames.ContainerName
