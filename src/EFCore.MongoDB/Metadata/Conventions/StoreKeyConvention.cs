...
/// <summary>
///     A convention that adds the 'id' property - a key required by Azure MongoDB.
/// </summary>
/// <remarks>
///     <para>
    ...
    IEntityTypeBaseTypeChangedConvention
{
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        ...
        else if (name == MongoDBAnnotationNames.PartitionKeyName)
        {
    ...
    public virtual void ProcessPropertyAnnotationChanged(
        ...
        IConventionContext<IConventionAnnotation> context)
    {
        if (name == MongoDBAnnotationNames.PropertyName
