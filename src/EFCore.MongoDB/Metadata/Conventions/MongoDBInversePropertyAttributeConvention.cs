...
///     All navigations are assumed to be targeting owned entity types for MongoDB.
/// </summary>
/// <remarks>
...
/// </remarks>
public class MongoDBInversePropertyAttributeConvention : InversePropertyAttributeConvention
{
    /// <summary>
    ///     Creates a new instance of <see cref="InversePropertyAttributeConvention" />.
    /// </summary>
    /// <param name="dependencies">Parameter object containing dependencies for this convention.</param>
    public MongoDBInversePropertyAttributeConvention(ProviderConventionSetBuilderDependencies dependencies)
        : base(dependencies)
    {
    }
...
#pragma warning disable EF1001 // Internal EF Core API usage.
            .GetTargetEntityTypeBuilder(
                ...
                MongoDBRelationshipDiscoveryConvention.ShouldBeOwnedType(targetClrType, entityTypeBuilder.Metadata.Model));
