...
public static class MongoDBEventId
{
    ...
    ///     </para>
    ///     <para>
    ///         This event uses the <see cref="MongoDBQueryEventData" /> payload when used with a <see cref="DiagnosticSource" />.
    ///     </para>
    /// </remarks>
    ...
    ///     </para>
    ///     <para>
    ///         This event uses the <see cref="MongoDBReadItemEventData" /> payload when used with a <see cref="DiagnosticSource" />.
    ///     </para>
    /// </remarks>
    ...
    ///     </para>
    ///     <para>
    ///         This event uses the <see cref="MongoDBQueryExecutedEventData" /> payload when used with a <see cref="DiagnosticSource" />.
    ///     </para>
    /// </remarks>
    ...
    ///     </para>
    ///     <para>
    ///         This event uses the <see cref="MongoDBItemCommandExecutedEventData" /> payload when used with a <see cref="DiagnosticSource" />.
    ///     </para>
    /// </remarks>
