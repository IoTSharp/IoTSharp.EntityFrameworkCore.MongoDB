...
/// <summary>
///     A <see cref="DiagnosticSource" /> event payload class for MongoDB item command executed events.
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-diagnostics">Logging, events, and diagnostics</see> for more information and examples.
/// </remarks>
public class MongoDBItemCommandExecutedEventData : EventData
{
    /// <summary>
    ...
    public MongoDBItemCommandExecutedEventData(
