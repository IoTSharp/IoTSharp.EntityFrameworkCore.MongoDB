...
public class MongoDBOptionsExtension : IDbContextOptionsExtension
{
    ...
    public virtual MongoDBOptionsExtension WithAccountEndpoint(string? accountEndpoint)
    {
        ...
        {
            throw new InvalidOperationException(MongoDBStrings.ConnectionStringConflictingConfiguration);
        }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithConnectionString(string? connectionString)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithLimitToEndpoint(bool enable)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithConnectionMode(ConnectionMode connectionMode)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithWebProxy(IWebProxy? proxy)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithRequestTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithOpenTcpConnectionTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithIdleTcpConnectionTimeout(TimeSpan? timeout)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithGatewayModeMaxConnectionLimit(int? connectionLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithMaxTcpConnectionsPerEndpoint(int? connectionLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithMaxRequestsPerTcpConnection(int? requestLimit)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension ContentResponseOnWriteEnabled(bool enabled)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual MongoDBOptionsExtension WithHttpClientFactory(Func<HttpClient>? httpClientFactory)
    {
        var clone = Clone();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected virtual MongoDBOptionsExtension Clone()
        => new(this);
